...
import { messageColumns } from "@/app/i/dashboard/polls/table/columns";
import { PollTableContext } from "./pollTableContext";
...
export default function PollTable({
  ...
  const { data, refetch } = useQuery({
    ...
    queryFn: () =>
      !archived
        ? messageService.getAll(perPage, page, search)
        : messageService.getArchived(perPage, page, search),
  });
  ...
  return (
    <PollTableContext.Provider value={{ page, perPage, search, refetch }}>
      <div>
        <Input
          className="w-80 mb-5"
